...
def eliminar_estudios_materia(id_materia: int) -> None:
    """
    funcion que se encarga de eliminar todos los estudios de una materia

    parametros:
        id_materia (int): id de la materia

    comportamiento:
        - ejecuta la consulta sql que se encarga de eliminar todos los estudios de la materia
